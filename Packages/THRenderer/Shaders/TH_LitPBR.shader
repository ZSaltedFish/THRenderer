Shader "THRenderer/LitPBR"
{
    Properties
    {
        _Color ("Color", color) = (1, 1, 1, 1)
        _MainTex ("Input Tex", 2D) = "white"{}
        _ExtendTexture ("Extend Texture", 2D) = "black" {}
        _MeSmoo ("PBR Texture", 2D) = "black" {}
        ...
        [Toggle(_PBR_SHADER)] _PBR_SHADER ("PBR Shader", float) = 1
    ...
    SubShader
    {
        Pass
        {
            ...
            #pragma shader_feature_local _PBR_SHADER
            #include "Include/THForwardLit.hlsl"
            #pragma vertex LightingVertex
            #pragma fragment LightingPBRFragment
            #pragma target 3.5
            ENDHLSL
        }
